...
(function ($, Drupal, drupalSettings) {
    Drupal.color = {
        ...
        callback: function callback(context, settings, $form) {
            ...
            var gradientEnd = $colorPalette.find('input[name="palette[highlighted]"]').val();
            ...
            $colorPreview.find('.color-preview-highlighted').css('background-color', $colorPalette.find('input[name="palette[highlighted]"]').val());
