...
This adds a new display style to views called "FlexSlider". Similar to how you
...
want to configure your Views display using FlexSlider through the web
interface. This ensures you can leave Views UI off once everything is setup.

Usage
=====

Go to Views and use the display mode "FlexSlider"
